...
public:
    ScreenDriverSSD1306(gpio_num_t pinSCL, gpio_num_t pinSDA, gpio_num_t pinEnable = GPIO_NUM_NC);
...
//    static const uint8_t ADDR_WRITE = 0b01111010;
    ...
    // If set to something other than default then this pin will be set high.
    // This is needed for the Heltec v3 board with attached oled
    gpio_num_t m_pinEnable;
